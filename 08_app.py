...
def _bat_features(ps, venue, team, date, fmt):
    ...
    return {
        ...
        'career_avg_decay': ps.get('career_avg_decay', ps['career_avg']),
        ...
        'form_vs_career': ps.get('form_vs_career', 1.0),
        'innings_position': 2.0,  # Default to top/middle order for featured players
        'modern_era':   era['modern_era'],
        'era_weight':   era['era_weight'],
        'venue_avg_runs':     vc['venue_avg_runs'],
        'venue_avg_wkts':     vc['venue_avg_wkts'],
        'venue_rolling_avg':  vc.get('venue_rolling_avg', vc['venue_avg_runs']),
        'recent_venue_avg_runs': vc.get('recent_venue_avg_runs', vc['venue_avg_runs']),
...
def _bowl_features(ps, venue, team, date, fmt):
    ...
    return {
        ...
        'career_wkt_decay': ps.get('career_wkt_decay', ps['career_wkt_avg']),
        ...
        'std_econ_5':     ps.get('std_econ_5', 1.0),
